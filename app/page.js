  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center content-center">
        ...
        <button type="button" onClick={handleLogin} className="mb-4 text-sm font-medium text-blue-600 dark:text-blue-500">
          登入
        </button>
        <button type="button" onClick={handleCreate} className="mb-4 text-sm font-medium text-white hover:underline">
          尚未擁有測試帳號？
        </button>
        <button type="button" onClick={handleForgetPwd} className="mb-4 text-sm font-medium text-white underline underline-offset-2">
          忘記密碼
        </button>
      </div>
    </div>

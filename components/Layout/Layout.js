      ...
      <section className="flex">
        <aside className="w-64" aria-label="Sidebar">
          <div className="h-full overflow-y-auto py-4 px-3 bg-gray-50 dark:bg-gray-800">
            <VStack as="ul" className="space-y-2">
              {pages.map(({ title, href }) => (
                <Box key={title} as="li" w='100%'>
        ...
        <section className="grow bg-black">
          <Breadcrumb className="flex px-5 py-3 text-gray-700 border border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            <BreadcrumbItem>
              <BreadcrumbLink href='/' className="flex items-center text-white">
